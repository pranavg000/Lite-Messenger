...
public class GlobalVariables {
    ...
    public static MongoCollection<Document> groupCollection;
    ...
    public static ExecutorService sendMessageService, receiveMessageService;
    ...
    public static enum RequestType {
        ...
        SignUpSuccessful, AuthSuccessful, NewChatPositive, MessageRead, NewGroup, AddGroupMember, NewGroupMemberAdded,
        AddedToGroup, GetGroupInfo, GroupInfo, RemoveGroupMember, GroupMemberRemoved, RemovedFromGroup
    }
    ...
    public static boolean sendMessageTo(String recieverId, Request request) {
        ...
        if (GlobalVariables.onlineClientsNew.containsKey(recieverId)) {
            ...
            GlobalVariables.sendMessageService.execute(new SendMessageTask(recieverInfo.getChannel(), request));
            return true;
        }
