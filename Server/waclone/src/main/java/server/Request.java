...
public class Request {
    ...
    Request(Document obj){
        ...
        this.groupId = (String)obj.get("groupId");
    ...
    public Document toDocument(){
        Document obj = new Document().append("requestId", requestId).append("senderId", senderId).append("receiverId", receiverId)
            .append("data", data).append("action", action.name()).append("groupId", groupId).append("token", token).append("timeStamp", timeStamp);
        return obj;
    }
    ...
    public String toString() {
        return "Request [requestId=" +requestId+ ", action=" + action.name() + ", data=" + data + ", receiverId=" + receiverId + ", senderId=" + senderId
                + ", groupId="+groupId+ ", token="+token+ ", timeStamp=" + String.valueOf(timeStamp) + "]";
    }
